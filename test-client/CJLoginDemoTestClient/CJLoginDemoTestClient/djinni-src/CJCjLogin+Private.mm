...
+ (nullable CJCjLogin *)create:(nonnull NSString *)server
    ...
    try {
        auto objcpp_result_ = ::cjlogin::CjLogin::create(::djinni::String::toCpp(server),
                                                         ::djinni::String::toCpp(serverCert),
                                                         ::djinni::String::toCpp(cert),
                                                         ::djinni::String::toCpp(key),
                                                         ::djinni::String::toCpp(sslOverride));
