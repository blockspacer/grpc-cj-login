...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/bin/bazel',
    '/private/var/tmp/_bazel_jeasonzhu/4765470fe39f5f338546f6fdd865fde7/execroot/__main__',
    'ios_x86_64',
    {
        'watchos_i386': [
    ...
    BazelFlagsSet(
        flags = BazelFlags(
            ...
            build = [
                '--apple_generate_dsym',
                '--copt=-fdebug-prefix-map=/private/var/tmp/_bazel_jeasonzhu/4765470fe39f5f338546f6fdd865fde7/execroot/__main__=/Users/jeasonzhu/Documents/Work/Code/MiniProject/grpc-cj-login/client',
            ],
        ),
    ),
    BazelFlagsSet(
