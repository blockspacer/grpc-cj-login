...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/bin/bazel',
    '/private/var/tmp/_bazel_jeasonzhu/c89b7494dee8c324e671c57c7851cb87/execroot/com_cj_login_client',
    'ios_x86_64',
    {
        'watchos_i386': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/jeasonzhu/Library/Application Support/Tulsi/0.4.207969836.20180808/Bazel',
    ...
    BazelFlagsSet(
        flags = BazelFlags(
            ...
            build = [
                '--apple_generate_dsym',
                '--copt=-fdebug-prefix-map=/private/var/tmp/_bazel_jeasonzhu/c89b7494dee8c324e671c57c7851cb87/execroot/com_cj_login_client=/Users/jeasonzhu/Documents/Work/Code/MiniProject/test/grpc-cj-login/client',
            ],
        ),
    ),
    BazelFlagsSet(
